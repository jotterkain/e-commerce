...
let AddressesService = class AddressesService {
    ...
    async create(addressDto) {
        var _a, _b;
        if (!(((_a = addressDto.neighborhood) === null || _a === void 0 ? void 0 : _a.trim()) || ((_b = addressDto.postalCode) === null || _b === void 0 ? void 0 : _b.trim()))) {
            throw new common_1.BadRequestException('Both neighborhood and PostalCode can\'t be empty.');
        }
        try {
